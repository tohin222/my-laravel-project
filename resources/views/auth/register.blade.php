                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" name="last_name" value="{{ old('first_name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="street_adress" type="text" class="form-control{{ $errors->has('street_adress') ? ' is-invalid' : '' }}" name="street_adress" value="{{ old('street_adress') }}" required>

                                @if ($errors->has('street_adress'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('street_adress') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
